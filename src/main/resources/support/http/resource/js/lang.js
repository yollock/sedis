...
cache.lang = function () {
    ...
    function setText($obj) {
        ...
        if (typeof(lang[key]) != 'undefined') {
            var text = lang[key][cache.lang.langNow];
            $obj.text(lang[key][cache.lang.langNow]);
        } else {
    ...
    function setTitle($obj) {
        var key = $obj.attr('langKey');
        if (typeof(lang[key]) != 'undefined') {
            var title = lang[key][cache.lang.langNow];
    ...
    return {
        ...
        init: function (langNow) {
            ...
            $(document).on('click', '.langSelector', function () {
                ...
                cache.lang.setLangType(langSelected);
                cache.lang.trigger();
                return false;
            });
        },
