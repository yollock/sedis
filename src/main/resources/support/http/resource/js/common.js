    ...
    return {
        ...
        buildFooter: function () {
            var html = '<footer class="footer">' +
                '    		<div class="container">' +
                '	powered by <a href="https://github.com/alibaba/" target="_blank">AlibabaTech</a> & <a href="support.http.resources://www.sandzhang.com/" target="_blank">sandzhang</a> & <a href="support.http.resources://melin.iteye.com/" target="_blank">melin</a> & <a href="https://github.com/shrekwang" target="_blank">shrek.wang</a>' +
                '			</div>' +
                ' </footer>';
        ...
        handleAjaxResult: function (data) {
            cache.common.handleCallback(data);
            if (!isOrderRequest) {
                cache.lang.trigger();
            }
        },//ajax 处理函数
        ajaxRequestForBasicInfo: function () {
            $.ajax({
                type: 'POST',
                url: cache.common.getAjaxUrl(cache.common.ajaxuri),
                success: function (data) {
                    cache.common.handleAjaxResult(data);
                },
                dataType: "json"
            });
        },
